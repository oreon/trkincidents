...
public abstract class DrugActionBase extends BaseAction<Drug>
	...
	public com.oreon.trkincidents.drugs.Drug findByUnqName(String name) {
		return executeSingleResultNamedQuery("drug.findByUnqName", name);
	}

	public com.oreon.trkincidents.drugs.Drug findByUnqDrugBankId(
			String drugBankId) {
	...
	protected List<com.oreon.trkincidents.drugs.DrugInteraction> listDrugInteractions = new ArrayList<com.oreon.trkincidents.drugs.DrugInteraction>();
	...
	public List<com.oreon.trkincidents.drugs.DrugInteraction> getListDrugInteractions() {
	...
	public void setListDrugInteractions(
			List<com.oreon.trkincidents.drugs.DrugInteraction> listDrugInteractions) {
