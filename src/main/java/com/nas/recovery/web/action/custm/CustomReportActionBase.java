...
public abstract class CustomReportActionBase extends BaseAction<CustomReport>
	...
	public com.oreon.trkincidents.custm.CustomReport findByUnqName(String name) {
	...
	protected List<com.oreon.trkincidents.custm.MetaField> listFields = new ArrayList<com.oreon.trkincidents.custm.MetaField>();
	...
	public List<com.oreon.trkincidents.custm.MetaField> getListFields() {
	...
	public void setListFields(
			List<com.oreon.trkincidents.custm.MetaField> listFields) {
		this.listFields = listFields;
	}

	protected List<com.oreon.trkincidents.custm.MetaField> listAvailableFields = new ArrayList<com.oreon.trkincidents.custm.MetaField>();
	...
	@Begin(join = true)
	public List<com.oreon.trkincidents.custm.MetaField> getListAvailableFields() {
	...
	public void setListAvailableFields(
			List<com.oreon.trkincidents.custm.MetaField> listAvailableFields) {
		this.listAvailableFields = listAvailableFields;
	}

	protected List<com.oreon.trkincidents.custm.MetaField> listGroupFields = new ArrayList<com.oreon.trkincidents.custm.MetaField>();
	...
	public List<com.oreon.trkincidents.custm.MetaField> getListGroupFields() {
	...
	public void setListGroupFields(
			List<com.oreon.trkincidents.custm.MetaField> listGroupFields) {
		this.listGroupFields = listGroupFields;
	}

	protected List<com.oreon.trkincidents.custm.MetaField> listAvailableGroupFields = new ArrayList<com.oreon.trkincidents.custm.MetaField>();
	...
	@Begin(join = true)
	public List<com.oreon.trkincidents.custm.MetaField> getListAvailableGroupFields() {
	...
	public void setListAvailableGroupFields(
			List<com.oreon.trkincidents.custm.MetaField> listAvailableGroupFields) {
