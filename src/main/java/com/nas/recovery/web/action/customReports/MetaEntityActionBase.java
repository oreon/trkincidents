...
public abstract class MetaEntityActionBase extends BaseAction<MetaEntity>
	...
	public com.oreon.trkincidents.customReports.MetaEntity findByUnqName(
			String name) {
	...
	protected List<com.oreon.trkincidents.customReports.MetaField> listMetaFields = new ArrayList<com.oreon.trkincidents.customReports.MetaField>();
	...
	public List<com.oreon.trkincidents.customReports.MetaField> getListMetaFields() {
	...
	public void setListMetaFields(
			List<com.oreon.trkincidents.customReports.MetaField> listMetaFields) {
