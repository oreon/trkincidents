...
public abstract class DrugListQueryBase extends BaseQuery<Drug, Long> {
	...
	private com.oreon.trkincidents.drugs.DrugCategory drugCategorysToSearch;

	public void setDrugCategorysToSearch(
			com.oreon.trkincidents.drugs.DrugCategory drugCategoryToSearch) {
		this.drugCategorysToSearch = drugCategoryToSearch;
	}

	public com.oreon.trkincidents.drugs.DrugCategory getDrugCategorysToSearch() {
	...
	public void createCsvString(StringBuilder builder, Drug e) {
		...
		builder.append("\""
				+ (e.getCategories() != null ? e.getCategories().replace(",",
						"") : "") + "\",");
