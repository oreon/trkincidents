...
public class Icd10 extends BusinessEntity implements java.io.Serializable {
	private static final long serialVersionUID = 420033308L;
	...
	@OneToMany(mappedBy = "icd10", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	//@JoinColumn(name = "icd10_ID", nullable = true)
	@OrderBy("dateCreated DESC")
	@IndexedEmbedded
	private Set<Incident> incidents = new HashSet<Incident>();

	public void addIncidents(Incident incidents) {
		incidents.setIcd10(this);
