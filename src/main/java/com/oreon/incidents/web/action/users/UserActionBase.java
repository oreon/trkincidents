...
public abstract class UserActionBase extends BaseAction<User>
	...
	public com.oreon.incidents.users.User findByUnqUserName(String userName) {
		return executeSingleResultNamedQuery("user.findByUnqUserName", userName);
	}

	public com.oreon.incidents.users.User findByUnqEmail(String email) {
		return executeSingleResultNamedQuery("user.findByUnqEmail", email);
	}
	...
	protected List<com.oreon.incidents.users.Role> listRoles = new ArrayList<com.oreon.incidents.users.Role>();
	...
	public List<com.oreon.incidents.users.Role> getListRoles() {
	...
	public void setListRoles(List<com.oreon.incidents.users.Role> listRoles) {
		this.listRoles = listRoles;
	}

	protected List<com.oreon.incidents.users.Role> listAvailableRoles = new ArrayList<com.oreon.incidents.users.Role>();
	...
	@Begin(join = true)
	public List<com.oreon.incidents.users.Role> getListAvailableRoles() {
	...
	public void setListAvailableRoles(
			List<com.oreon.incidents.users.Role> listAvailableRoles) {
