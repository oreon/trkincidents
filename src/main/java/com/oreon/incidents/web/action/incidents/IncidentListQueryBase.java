...
public abstract class IncidentListQueryBase extends BaseQuery<Incident, Long> {
	...
	public List<Incident> getIncidentsByPatient(
			com.oreon.incidents.patient.Patient patient) {
		//setMaxResults(10000);
	...
	public List<Incident> getIncidentsCreatedByCreatedBy(
			com.oreon.incidents.employee.Employee employee) {
		//setMaxResults(10000);
	...
	public List<Incident> getIncidentsByDepartment(
			com.oreon.incidents.employee.Department department) {
		//setMaxResults(10000);
	...
	public List<Incident> getIncidentsByProccedure(
			com.oreon.incidents.incidents.Proccedure proccedure) {
		//setMaxResults(10000);
	...
	public List<Incident> getIncidentsByWard(
			com.oreon.incidents.incidents.Ward ward) {
		//setMaxResults(10000);
	...
	public List<Incident> getIncidentsByDrug(com.oreon.incidents.drugs.Drug drug) {
		//setMaxResults(10000);
	...
	public List<Incident> getIncidentsByMorbidity(
			com.oreon.incidents.incidents.Morbidity morbidity) {
		//setMaxResults(10000);
