...
public abstract class FormFieldInstanceActionBase
	...
	com.oreon.incidents.web.action.incidents.FormFieldAction formFieldAction;

	@In(create = true, value = "incidentAction")
	com.oreon.incidents.web.action.incidents.IncidentAction incidentAction;
	...
	protected FormFieldInstance createInstance() {
		FormFieldInstance instance = super.createInstance();
	...
	public void wire() {
		...
		com.oreon.incidents.incidents.FormField formField = formFieldAction
				.getDefinedInstance();
		if (formField != null && isNew()) {
			getInstance().setFormField(formField);
		}

		com.oreon.incidents.incidents.Incident incident = incidentAction
				.getDefinedInstance();
	...
	public void setFormFieldInstance(FormFieldInstance t) {
		...
		if (formFieldInstance != null)
			setFormFieldInstanceId(t.getId());
		loadAssociations();
	}
	...
	public String viewFormFieldInstance() {
		load(currentEntityId);
		return "viewFormFieldInstance";
	}
