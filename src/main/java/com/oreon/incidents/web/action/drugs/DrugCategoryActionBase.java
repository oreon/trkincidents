...
public abstract class DrugCategoryActionBase extends BaseAction<DrugCategory>
	...
	public com.oreon.incidents.drugs.DrugCategory findByUnqName(String name) {
	...
	protected List<com.oreon.incidents.drugs.Drug> listDrugs = new ArrayList<com.oreon.incidents.drugs.Drug>();
	...
	public List<com.oreon.incidents.drugs.Drug> getListDrugs() {
	...
	public void setListDrugs(List<com.oreon.incidents.drugs.Drug> listDrugs) {
		this.listDrugs = listDrugs;
	}

	protected List<com.oreon.incidents.drugs.Drug> listAvailableDrugs = new ArrayList<com.oreon.incidents.drugs.Drug>();
	...
	@Begin(join = true)
	public List<com.oreon.incidents.drugs.Drug> getListAvailableDrugs() {
	...
	public void setListAvailableDrugs(
			List<com.oreon.incidents.drugs.Drug> listAvailableDrugs) {
