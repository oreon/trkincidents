...
public abstract class MetaEntityActionBase extends BaseAction<MetaEntity>
	...
	public com.oreon.incidents.customReports.MetaEntity findByUnqName(
			String name) {
	...
	protected List<com.oreon.incidents.customReports.MetaField> listMetaFields = new ArrayList<com.oreon.incidents.customReports.MetaField>();
	...
	public void setListMetaFields(
			List<com.oreon.incidents.customReports.MetaField> listMetaFields) {
