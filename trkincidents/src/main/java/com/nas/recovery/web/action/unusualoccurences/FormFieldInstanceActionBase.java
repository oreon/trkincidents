...
public abstract class FormFieldInstanceActionBase
	...
	com.nas.recovery.web.action.unusualoccurences.IncidentAction incidentAction;

	@In(create = true, value = "formFieldAction")
	com.nas.recovery.web.action.unusualoccurences.FormFieldAction formFieldAction;
	...
	public void wire() {
		...
		com.oreon.trkincidents.unusualoccurences.Incident incident = incidentAction
				.getDefinedInstance();
		if (incident != null && isNew()) {
			getInstance().setIncident(incident);
		}

		com.oreon.trkincidents.unusualoccurences.FormField formField = formFieldAction
				.getDefinedInstance();
