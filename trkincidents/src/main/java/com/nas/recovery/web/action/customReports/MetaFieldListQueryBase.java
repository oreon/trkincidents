...
public abstract class MetaFieldListQueryBase extends BaseQuery<MetaField, Long> {
	...
	private com.oreon.trkincidents.customReports.CustomReport customReportsToSearch;

	public void setCustomReportsToSearch(
			com.oreon.trkincidents.customReports.CustomReport customReportToSearch) {
		this.customReportsToSearch = customReportToSearch;
	}

	public com.oreon.trkincidents.customReports.CustomReport getCustomReportsToSearch() {
		return customReportsToSearch;
	}

	private com.oreon.trkincidents.customReports.CustomReport groupReportToSearch;
	...
	public com.oreon.trkincidents.customReports.CustomReport getGroupReportToSearch() {
	...
	public List<MetaField> getMetaFieldsByMetaEntity(
			com.oreon.trkincidents.customReports.MetaEntity metaEntity) {
		//setMaxResults(10000);
