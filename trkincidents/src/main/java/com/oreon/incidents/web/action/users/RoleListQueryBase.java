...
public abstract class RoleListQueryBase extends BaseQuery<Role, Long> {
	...
	private com.oreon.incidents.users.User usersToSearch;

	public void setUsersToSearch(com.oreon.incidents.users.User userToSearch) {
		this.usersToSearch = userToSearch;
	}

	public com.oreon.incidents.users.User getUsersToSearch() {
