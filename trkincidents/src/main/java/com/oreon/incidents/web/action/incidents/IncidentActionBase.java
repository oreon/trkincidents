...
public abstract class IncidentActionBase extends BaseAction<Incident>
	...
	com.oreon.incidents.web.action.patient.PatientAction patientAction;

	@In(create = true, value = "employeeAction")
	com.oreon.incidents.web.action.employee.EmployeeAction createdByAction;
	...
	com.oreon.incidents.web.action.incidents.ProccedureAction proccedureAction;

	@In(create = true, value = "employeeAction")
	com.oreon.incidents.web.action.employee.EmployeeAction responsibleEmployeeAction;

	@In(create = true, value = "severityAction")
	com.oreon.incidents.web.action.incidents.SeverityAction severityAction;

	@In(create = true, value = "wardAction")
	com.oreon.incidents.web.action.incidents.WardAction wardAction;

	@In(create = true, value = "employeeAction")
	com.oreon.incidents.web.action.employee.EmployeeAction reportedToAction;
	...
	com.oreon.incidents.web.action.incidents.MorbidityAction morbidityAction;
	...
	protected Incident createInstance() {
		Incident instance = super.createInstance();
	...
	public void wire() {
		...
		com.oreon.incidents.patient.Patient patient = patientAction
				.getDefinedInstance();
		if (patient != null && isNew()) {
			getInstance().setPatient(patient);
		}

		com.oreon.incidents.employee.Employee createdBy = createdByAction
				.getDefinedInstance();
		...
		com.oreon.incidents.incidents.Proccedure proccedure = proccedureAction
				.getDefinedInstance();
		if (proccedure != null && isNew()) {
			getInstance().setProccedure(proccedure);
		}

		com.oreon.incidents.employee.Employee responsibleEmployee = responsibleEmployeeAction
				.getDefinedInstance();
		if (responsibleEmployee != null && isNew()) {
			getInstance().setResponsibleEmployee(responsibleEmployee);
		}

		com.oreon.incidents.incidents.Severity severity = severityAction
				.getDefinedInstance();
		if (severity != null && isNew()) {
			getInstance().setSeverity(severity);
		}

		com.oreon.incidents.incidents.Ward ward = wardAction
				.getDefinedInstance();
		if (ward != null && isNew()) {
			getInstance().setWard(ward);
		}

		com.oreon.incidents.employee.Employee reportedTo = reportedToAction
				.getDefinedInstance();
		...
		com.oreon.incidents.incidents.Morbidity morbidity = morbidityAction
				.getDefinedInstance();
	...
	protected List<com.oreon.incidents.incidents.FormFieldInstance> listFormFieldInstances = new ArrayList<com.oreon.incidents.incidents.FormFieldInstance>();
	...
	public void setListFormFieldInstances(
			List<com.oreon.incidents.incidents.FormFieldInstance> listFormFieldInstances) {
