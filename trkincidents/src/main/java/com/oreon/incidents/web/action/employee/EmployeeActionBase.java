...
public abstract class EmployeeActionBase
		extends
			com.oreon.incidents.web.action.patient.PersonAction<Employee>
		implements
	...
	com.oreon.incidents.web.action.users.UserAction userAction;

	@In(create = true, value = "departmentAction")
	com.oreon.incidents.web.action.employee.DepartmentAction departmentAction;

	@In(create = true, value = "incidentAction")
	com.oreon.incidents.web.action.incidents.IncidentAction incidentsCreatedAction;

	@In(create = true, value = "incidentAction")
	com.oreon.incidents.web.action.incidents.IncidentAction incidentsResponsibleForAction;

	@In(create = true, value = "incidentAction")
	com.oreon.incidents.web.action.incidents.IncidentAction incidentsReportedAction;
	...
	public void wire() {
		...
		com.oreon.incidents.users.User user = userAction.getDefinedInstance();
		if (user != null && isNew()) {
			getInstance().setUser(user);
		}

		com.oreon.incidents.employee.Department department = departmentAction
				.getDefinedInstance();
	...
	public void updateAssociations() {
		...
		com.oreon.incidents.incidents.Incident incidentsCreated = (com.oreon.incidents.incidents.Incident) org.jboss.seam.Component
				.getInstance("incident");
		incidentsCreated.setCreatedBy(employee);
		events.raiseTransactionSuccessEvent("archivedIncident");

		com.oreon.incidents.incidents.Incident incidentsResponsibleFor = (com.oreon.incidents.incidents.Incident) org.jboss.seam.Component
				.getInstance("incident");
		incidentsResponsibleFor.setResponsibleEmployee(employee);
		events.raiseTransactionSuccessEvent("archivedIncident");

		com.oreon.incidents.incidents.Incident incidentsReported = (com.oreon.incidents.incidents.Incident) org.jboss.seam.Component
				.getInstance("incident");
	...
	protected List<com.oreon.incidents.incidents.Incident> listIncidentsCreated = new ArrayList<com.oreon.incidents.incidents.Incident>();
	...
	public void setListIncidentsCreated(
			List<com.oreon.incidents.incidents.Incident> listIncidentsCreated) {
	...
	protected List<com.oreon.incidents.incidents.Incident> listIncidentsResponsibleFor = new ArrayList<com.oreon.incidents.incidents.Incident>();
	...
	public void setListIncidentsResponsibleFor(
			List<com.oreon.incidents.incidents.Incident> listIncidentsResponsibleFor) {
	...
	protected List<com.oreon.incidents.incidents.Incident> listIncidentsReported = new ArrayList<com.oreon.incidents.incidents.Incident>();
	...
	public void setListIncidentsReported(
			List<com.oreon.incidents.incidents.Incident> listIncidentsReported) {
