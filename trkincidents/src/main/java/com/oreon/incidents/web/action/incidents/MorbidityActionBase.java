...
public abstract class MorbidityActionBase extends BaseAction<Morbidity>
	...
	protected Morbidity createInstance() {
		Morbidity instance = super.createInstance();
	...
	public com.oreon.incidents.incidents.Morbidity findByUnqCode(String code) {
	...
	public String viewMorbidity() {
		load(currentEntityId);
		return "viewMorbidity";
	}
