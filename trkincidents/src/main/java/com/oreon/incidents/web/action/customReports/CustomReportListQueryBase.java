...
public abstract class CustomReportListQueryBase
	...
	private com.oreon.incidents.customReports.MetaField fieldsToSearch;

	public void setFieldsToSearch(
			com.oreon.incidents.customReports.MetaField metaFieldToSearch) {
		this.fieldsToSearch = metaFieldToSearch;
	}

	public com.oreon.incidents.customReports.MetaField getFieldsToSearch() {
		return fieldsToSearch;
	}

	private com.oreon.incidents.customReports.MetaField groupFieldsToSearch;
	...
	public com.oreon.incidents.customReports.MetaField getGroupFieldsToSearch() {
